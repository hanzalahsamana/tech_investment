    ...
    <header className={`bg-light custom-header`}>
      <nav className={`navbar navbar-expand-lg navbar-light bg-light my-new-class ${isScrolled ? 'fixed-top' : ''}`} id="header-nav" role="navigation">
        <div className="container">
          <a className="link-dark navbar-brand site-title mb-0" href="#about"><img alt="logo" src={logo}className='logo-image' width={'150px'} height={'100px'}/> Tech Invest</a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a className="btn btn-primary" href="#contact" id='btn-theme-color'>Get Started</a>
          </div>
        </div>
      </nav>
    </header>
